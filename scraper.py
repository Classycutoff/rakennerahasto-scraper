...
def extract_links(url, keyword):
    ...
    keyword_links = ['https://www.eura2014.fi/rrtiepa/' + a['href'].lstrip('/') for a in links if keyword in a['href']]
...
def extract_data(url):
    ...
    for div in description_divs:
        ...
        elif category in ["7 Hakemusvaiheessa ilmoitettavat arviot hankekohtaisista seurantiedoista"]:
